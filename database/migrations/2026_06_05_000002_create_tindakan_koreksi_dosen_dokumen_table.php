...
return new class extends Migration
{
    ...
    {
        Schema::create('tindakan_koreksi_dosen_dokumen', function (Blueprint $table) {
            $table->uuid('dokumen_tk_dosen_id')->primary();
    ...
    {
        Schema::dropIfExists('tindakan_koreksi_dosen_dokumen');
    }
};
