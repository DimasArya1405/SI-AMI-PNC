                ...
                <form id="form-tambah-penugasan" action="{{ route('admin.ami.penugasan.tambah') }}" method="post">
                    ...
                    <div class="grid gap-4 grid-cols-2 py-4 md:py-6">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="date" name="tanggal" id="price" min="{{ now()->toDateString() }}"
                ...
                <form action="{{ route('admin.ami.penugasan.edit') }}" method="post">
                    ...
                    <div class="grid gap-4 grid-cols-2 py-4 md:py-6">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="text" name="jam" id="jam_2" maxlength="4" placeholder="0800"
                                data-assignment-time title="Masukkan 4 digit jam, contoh 0800 sampai 1600"
                                class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                                required="">
                        </div>
    ...
    @push('js')
        <script>
            ...
            $('#form-tambah-penugasan').on('submit', function(e) {
                ...
                if (!validateAssignmentForm(this)) {
                    return;
                }
            ...
            $(document).on('click', '.button-edit-penugasan', function() {
                ...
                $('#jam_2').val(String(jam).substring(0, 5));
                $('#tanggal').val(tanggal);
            });
        </script>
    @endpush
