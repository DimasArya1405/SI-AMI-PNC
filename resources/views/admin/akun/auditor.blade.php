            ...
            <div class="relative bg-white border border-default rounded-base shadow-sm p-4 md:p-6">
                ...
                <form action="{{ route('admin.auditor.edit') }}" method="post">
                    ...
                    <div class="grid gap-4 grid-cols-2 py-4 md:py-6">
                        ...
                        <div class="col-span-2">
                            <label class="block mb-2.5 text-sm font-medium text-heading">Prodi</label>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label class="block mb-2.5 text-sm font-medium text-heading">No. HP</label>
                    ...
                    <div class="flex items-center space-x-4 border-t border-default pt-4 md:pt-6">
                        ...
                        <button type="submit"
                            class="inline-flex items-center text-white bg-blue-500 hover:bg-blue-700 border border-transparent shadow-xs font-medium rounded-base text-sm px-4 py-2.5 transition">

                            Simpan
                        </button>

                        <button data-modal-hide="modal-edit" type="button"
                            class="text-body bg-white hover:bg-gray-200 border border-gray-400 rounded-base text-sm px-4 py-2.5 transition">
                            Batal
                        </button>
