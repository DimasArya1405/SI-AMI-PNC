<aside class="fixed left-0 top-16 min-h-screen w-60 bg-white border-r border-gray">
    <div class="flex flex-col p-2 gap-1">
        <a href="{{ route('admin.dashboard') }}"
            class="px-6 py-2 text-gray-600 rounded-sm cursor-pointer hover:bg-blue-500 hover:text-white transition duration-200 ease-in-out
            {{ request()->routeIs('admin.dashboard') ? 'bg-blue-500 text-white' : '' }}">
            <i class="bi bi-house-door mr-2 text-xl"></i> Dashboard
        </a>
        <div class="px-6 flex justify-between items-center py-2 rounded-sm cursor-pointer transition duration-200 ease-in-out
        ...
        <ul id="dp-akun"
            ...
            <li>
                <a href="{{ route('admin.akun.auditor') }}"
                    class="pl-5 flex items-center px-2 py-1.5 rounded-sm transition duration-200 ease-in-out
        ...
        <div class="px-6 flex justify-between items-center py-2 text-gray-600 rounded-sm cursor-pointer hover:bg-blue-500 hover:text-white transition duration-200 ease-in-out"
        ...
        <ul id="dp-audit" class="pl-6 hidden py-2 space-y-2">
            <li>
                <a href="#"
                    class="pl-5 flex items-center px-2 py-1.5  text-gray-600 rounded-sm cursor-pointer hover:bg-blue-500 hover:text-white transition duration-200 ease-in-out">
