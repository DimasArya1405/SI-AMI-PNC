...
<body class="font-sans antialiased">
    ...
    @if (session('success'))
        ...
        <div id="toast-success"
            class="fixed bg-green-500/70 rounded text-white top-5 right-5 z-50 flex items-center w-full max-w-sm p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default"
            role="alert">
            <div
    ...
    @elseif (session('error'))
        {
        <div id="toast-error"
            class="fixed bg-red-500/70 rounded text-white top-5 right-5 z-50 flex items-center w-full max-w-sm p-4 text-body bg-neutral-primary-soft rounded-base shadow-xs border border-default"
            role="alert">
