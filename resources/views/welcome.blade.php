...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <!-- HERO SECTION -->
    <section class="max-w-6xl mx-auto px-8 py-24 grid md:grid-cols-2 gap-12 items-center">

        <div>
            <h1 class="text-4xl font-bold mb-6 leading-tight">
                Sistem Informasi <br>
                <span class="text-blue-600">Audit Mutu Internal</span>
            </h1>

            <p class="text-gray-600 mb-8">
                Platform digital untuk membantu pengelolaan audit mutu internal
                secara efektif, transparan, dan terintegrasi dalam meningkatkan
                kualitas institusi.
            </p>
        ...
        <div>
            <div class="bg-white rounded-2xl shadow-xl p-10 text-center">
                ...
                <p class="text-gray-500 text-sm">
                    Kelola auditor, jadwal audit, temuan audit,
                    dan laporan secara terintegrasi dalam satu sistem.
                </p>
            </div>
        </div>
    ...
    <!-- FOOTER -->
    <footer class="text-center text-sm bg-white text-gray-500 py-6">
        © {{ date('Y') }} Sistem Audit Mutu Internal
    </footer>
